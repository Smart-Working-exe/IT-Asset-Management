    ...
    <table class="table table-striped table-bordered" id="devices">
        ...
        @foreach($data as $lizenz)
            ...
            <form action="datenbank?database=lizenzen" method="POST">
                ...
                <!-- The Modal -->
                <div class="modal fade" id="editSoftware{{$lizenz['id']}}" tabindex="-1" aria-labelledby="editSoftware" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            <input class="form-control" type="text" name="form_lizenzhersteller" placeholder="Hersteller*" value="{{$lizenz['hersteller']}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group date" id="datepickerEditAvailable">
                                                <input type="text" name="form_lizenzerwerb" class="form-control" placeholder="Erwerbsdatum" value="{{$lizenz['erwerbsdatum']}}">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="input-group date" id="datepickerEditNotAvailable">
                                                <input type="text" name="form_lizenzablauf" class="form-control" placeholder="Ablaufdatum" value="{{$lizenz['ablaufdatum']}}">
                                                <span class="input-group-append">
                                        <span class="input-group-text bg-white d-block">
                                            <i class="fa fa-calendar"></i>
                                        </span>
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        <input class="form-control" type="number" name="form_lizenzanzahl"
                                               placeholder="Anzahl verfügbarer Installation" value="{{$lizenz['anzahl_gerate']}}">
                                    </div>
                                </div>
                            </div>
                            <!-- Modal footer -->
                            <div class="modal-footer justify-content-between">
                                ...
                                <div>
                                    <button type="submit" class="btn btn-primary" data-bs-dismiss="modal" name="submit" value="3">Speichern</button>

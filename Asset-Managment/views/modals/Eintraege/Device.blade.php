                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col">
                                    <input class="form-control" type="text" id="deviceName" name="addDeviceIP"
                                           placeholder="IP-Adresse"></div>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
                                    <input class="form-control" type="text" id="deviceName" name="addDeviceHersteller"
                    ...
                    <textarea class="form-control" id="comment" rows="5"
                            ...
                            <div class="mt-3">
                                ...
                                <input class="form-control" type="file" id="dataImport"
